...
{
    public class SunAndMoonOld : IDisposable
    {
        ...
        public SunAndMoonOld(Circle sun, Circle moon)
        {
            _sun = sun;
            _moon = moon;
        ...
        public static SunAndMoonOld CreateSetup(decimal sunDiameter, decimal sunAltitude, decimal moonDiameter, decimal moonAltitude, DateTime time)
        {
            ...
            return new SunAndMoonOld(Sun, Moon);
        }
    }
}
